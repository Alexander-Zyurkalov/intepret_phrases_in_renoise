...
describe("note_to_string", function()
    ...
    it("returns OFF",  function() assert.are.equal("OFF", PR.note_to_string(120)) end)
    it("returns ---",  function() assert.are.equal("---", PR.note_to_string(121)) end)
    it("returns ???",  function() assert.are.equal("???", PR.note_to_string(200)) end)
end)
...
describe("string_to_note", function()
    ...
    it("handles OFF", function() assert.are.equal(120, PR.string_to_note("OFF")) end)
    it("handles ---", function() assert.are.equal(121, PR.string_to_note("---")) end)
...
describe("_transpose_note", function()
    ...
    it("clamps at 0",             function() assert.are.equal(0,  PR._transpose_note(5, -10)) end)
    it("clamps at 119",           function() assert.are.equal(119, PR._transpose_note(115, 10)) end)
    it("leaves NOTE_OFF unchanged",  function() assert.are.equal(120, PR._transpose_note(120, 5)) end)
    it("leaves NOTE_EMPTY unchanged", function() assert.are.equal(121, PR._transpose_note(121, 5)) end)
end)
...
describe("pattern_line_iter", function()
    ...
    it("returns nil for empty phrase iterator", function()
        local iter = PR.pattern_line_iter(function() return nil end, 4)
        assert.is_nil(iter())
    end)
